...
count_vect = CountVectorizer(stop_words=stop_words1,ngram_range=(1,3))
...
#filename = '../Models/Voting_innovtiveness.sav'
#pickle.dump(clf, open(filename, 'wb'))
#vect_file = "../Models/Vectorizer_Innovativeness.sav"
#pickle.dump(count_vect, open(vect_file, 'wb'))
