...
#THIS CRAWLER IS UNFINISHED, IT DOES NOT WORK. WE HAVE CONTACTED EIB for the data. Website is tricky
...
class EIBProjectsSpider(scrapy.Spider):
    name = "EIB_Projects"
    ...
    def start_requests(self):
        ...
        #for i in range(20020114,20171136):
        urls.append("http://www.eib.org/projects/pipelines/pipeline/20170068")
        for url in urls:
    ...
    def parse_data(self,response):
        ...
        name = strip_tags(response.xpath('//h2').extract()[0])
        if name == "":
            return
